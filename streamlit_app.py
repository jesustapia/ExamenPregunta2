...
st.title("💬 Chatbot parce")
st.write(
    "Este es un bot sencillo que lo asistirá usando el dialecto local de colombia"
)
...
if not openai_api_key:
    st.info("Ingresa tu OpenAI API key para continuar.", icon="🗝️")
else:
